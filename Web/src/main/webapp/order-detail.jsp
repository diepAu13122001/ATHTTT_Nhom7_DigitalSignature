	...
	<div class="page-wrap d-flex flex-row align-items-center">
		...
		<div class="container my-5">
			...
			<c:if test="${message!=null}">
				<div class="alert alert-danger" role="alert">${message} <a href="./orders">(Xem danh sách đơn hàng)</a></div>
			</c:if>
				...
				<div class="row">
								...
								<div class="mb-3">
									...
									<div class="input-group">
										<input type="text" class="form-control" id="name"
											name="name-receiver" placeholder="" required
											...
											<table class="table table-bordered">
												...
												<tbody>
													<c:forEach items="${orders.orderDetails}" var="order">
														<input type="hidden" value="${order.product.idProduct}"
															name="id-product">
														<tr>
															<td>${order.product.nameProduct}</td>
															<td class='text-center'><input
																value="${order.quantity}" type="number"
																onchange="checkQuantity(this,${order.quantity})"
																name="quantity"></td>
					...
					<div class="col-12 d-flex shopping-box">
						<button type="submit" class="ml-auto btn hvr-hover"
							id="update-order" style="display: none">Cập nhật</button>
						<a class="ml-auto btn hvr-hover" onclick="submitUpdate()">Cập
							nhật</a>
					</div>
					<hr class="mb-4">
				</div>
