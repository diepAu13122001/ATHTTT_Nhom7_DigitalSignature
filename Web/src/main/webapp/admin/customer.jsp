                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach begin="0" end="${customers.size()-1}" var="i">
                                    	<tr>
                          
                                            <td>${customers.get(i).lastName}</td>
                                            <td>${customers.get(i).firstName}</td>
                                            <td>${customers.get(i).email}</td>
                                            <td>${customers.get(i).numberOrders}</td>
                                             <td>${customers.get(i).numberReviews}</td>
