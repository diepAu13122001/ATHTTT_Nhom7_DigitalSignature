		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					<span class="display-1 d-block" style="font-size: 2rem">Đơn hàng xác đang được xử lý sau 24h</span> 
					<div style="margin: 20px 0"><a href="./orders" class='btn btn-labeled btn-info' style='color: #fff; ' >
					<span class='btn-label'><i class="fas fa-arrow-circle-left"></i></span> Xem đơn hàng</a></div> 
					<img
						class="plugin-icon" width="300"
						src="https://www.inventicons.com/uploads/iconset/705/wm/512/Order_processing-21.png">
				</div>
