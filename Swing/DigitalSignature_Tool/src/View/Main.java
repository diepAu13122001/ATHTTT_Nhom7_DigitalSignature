...
public class Main extends JFrame {
	...
	private void initComponents() {
		...
		rsaMenu = new javax.swing.JMenuItem();
		...
		jPanel9.setPreferredSize(new java.awt.Dimension(1000, 2550));
		...
		jLabel4.setText(
				"https://docs.google.com/document/d/1Y2ITvmS79On7EJEmRA6csEF8zDwarO9AoDGmR_0W8B0/edit?usp=sharing");
		...
		exportBillAfterSignBtn.setText("Xuất file đã ký");
		...
		rsaMenu.setText("Thuật toán RSA");
		rsaMenu.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				rsaMenuActionPerformed(evt);
			}
		});
		digitalSignatureMenu.add(rsaMenu);

		aesMenu.setText("Thuật toán AES");
		aesMenu.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				aesMenuActionPerformed(evt);
			}
		});
		digitalSignatureMenu.add(aesMenu);
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				parent, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
	...
	private void rsaMenuActionPerformed(java.awt.event.ActionEvent evt) {
	...
	private void aesMenuActionPerformed(java.awt.event.ActionEvent evt) {
//        this.parent.removeAll();
//        this.parent.add(this.aesPanel);
//        this.parent.repaint();
//        this.parent.revalidate();
	}
	...
	// for text file only (pdf not yet)
	...
	private javax.swing.JMenuItem rsaMenu;
